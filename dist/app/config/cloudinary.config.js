...
exports.cloudinaryUpload = exports.deleteCloudinaryImage = exports.uploadBufferToCloudinary = void 0;
...
const deleteCloudinaryImage = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield cloudinary_1.v2.uploader.destroy(publicId, { invalidate: true });
    }
    catch (error) {
        console.log(error);
