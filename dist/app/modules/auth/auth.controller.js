...
const credentialLogin = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    passport_1.default.authenticate("local", (err, user, info) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, sendResponse_1.default)(res, {
            ...
            data: Object.assign({ accessToken: userTokens.accessToken, refreshToken: userTokens.refreshToken }, rest),
        });
    }))(req, res, next);
}));
...
const setPassword = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield auth_service_1.AuthServices.setPassword(decodedUser.userId, plainPassword);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_codes_1.StatusCodes.OK,
        message: 'Password Changed Successfully!',
