...
const getUserStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const activeUsersPromise = user_model_1.User.countDocuments({ isActive: user_interface_1.IsActive.ACTIVE });
    const inActiveUsersPromise = user_model_1.User.countDocuments({ isActive: user_interface_1.IsActive.INACTIVE });
    const blockedUsersPromise = user_model_1.User.countDocuments({ isActive: user_interface_1.IsActive.BLOCKED });
    ...
    const [totalUsers, activeUsers, inActiveUsers, blockedUsers, newUsersLast7Days, newUsersLast30Days, usersByRole] = yield Promise.all([
        totalUsersPromise,
        activeUsersPromise,
...
const getTourStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalHighestBookedTourPromise = tour_model_1.Tour.aggregate([
        {
            $group: {
                _id: '$tour',
                bookingCount: { $sum: 1 },
    ...
    const [totalTours, totalTourByTourType, avgCostFrom, totalTourByDivision, totalHighestBookedTour,] = yield Promise.all([
        totalToursPromise,
