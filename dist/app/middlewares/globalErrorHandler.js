...
const globalErrorHandler = (err, req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.files && Array.isArray(req.files) && ((_a = req.files) === null || _a === void 0 ? void 0 : _a.length) > 0) {
        const files = req.files;
        yield Promise.all(files.map(file => (0, cloudinary_config_1.deleteCloudinaryImage)(file.path)));
    }
    let statusCode = 500;
